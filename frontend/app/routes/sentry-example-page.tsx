  ...
  return (
    <div>
      ...
      >
        ...
        <p className="mb-8">Get started by sending us a sample error:</p>
        ...
        <Form className="m-4" method="POST">
          <Button variant="destructive">Server-side Error</Button>
        </Form>

        <p>
          Next, look for the error on the{" "}
          <a href="https://glitchtip.11apps.net/organizations/linkt/issues/?project=1">
            Issues Page
          </a>
          .
        </p>
